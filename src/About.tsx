    ...
    <section className={styles.about}>
      ...
      <div className={styles.bio}>
        ...
        <p>
          ...
          coherence while allowing for improv. <b>As a software systems integrator</b> leading
          a 4-person team, it meant designing workflows that synchronized our
          efforts, eliminated thrashing, and doubled our output; we ended up shipping
